...
#file = os.path.abspath(os.path.join("README.md"))
file = os.path.abspath(os.path.join("test_save.sav"))
print(file)

print("get website")
#driver.get("https://bestvpn.org/html5demos/file-api/")
driver.get("https://satisfactory-calculator.com/en/interactive-map")

print("drop file")
#dropzone = driver.find_element(by=By.ID, value="holder")
dropzone = driver.find_element(by=By.ID, value="dropSaveGame")
dropzone.drop_files(file)

print("wait")
time.sleep(10)

print("find file")
modalproduction = driver.find_element(by=By.ID, value="statisticsModalProduction")
print(modalproduction)
